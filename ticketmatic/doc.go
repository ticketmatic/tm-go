// The Ticketmatic API is a REST (http://en.wikipedia.org/wiki/Representational_state_transfer)
// API. The API is designed to have predictable, resource-oriented URLs and to use HTTP response
// codes to indicate API errors.
//
// You can make requests to Ticketmatic API from a terminal or browser, or from within any code.
// The examples in the documentation use curl, but you can use wget, libcurl or any other method
// to GET and POST in your preferred language. Your preferred coding language should include
// libraries to support making HTTP requests and parsing responses.
//
// URI
//
...
// Audit log
//
// All calls to the API are logged, and you can inspect these using the Audit Log tool in your
// account.
//
// Help Center
//
